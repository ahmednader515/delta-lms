...
export default function HomePage() {
  ...
  return (
    <div className="h-full w-full bg-background">
        ...
        <ScrollProgress />
      {/* Hero Section */}
      <section id="hero-section" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-24 md:pt-0 bg-gradient-to-t from-brand/25 via-brand/10 to-transparent">
          ...
          >
            <div className="relative w-64 h-64 md:w-80 md:h-80">
              <Image
                ...
                fill
                priority
                className="object-cover object-[center_20%] rounded-full border-4 border-brand/20 shadow-lg"
