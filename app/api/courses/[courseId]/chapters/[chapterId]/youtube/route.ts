...
export async function POST(
    ...
    try {
        ...
        // Allow admins to add YouTube videos to any chapter, or teachers to their own courses
        if (user?.role === "ADMIN") {
            // Admin can add YouTube videos to any chapter, no need to check course ownership
        } else {
