...
import { ArrowLeft, CreditCard, Wallet, AlertCircle, Ticket, Check, Info } from "lucide-react";
...
export default function PurchasePage({
  ...
  const handlePurchase = async () => {
    ...
    // Show payment notification first
          ...
          <div className="space-y-4">
            ...
            {showPaymentNotification && (
              <Alert className="border-blue-200 bg-blue-50">
                ...
                <AlertTitle className="text-blue-800 font-semibold mb-2">تنويه</AlertTitle>
                <AlertDescription className="text-blue-700">
                  {t("search.paymentNotification")}
                  <div className="mt-2">
                    <a 
                      href={`https://wa.me/20${t("search.technicalSupportWhatsapp")}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="font-semibold underline hover:text-blue-800"
                    >
                      واتساب الدعم الفنى: {t("search.technicalSupportWhatsapp")}
                    </a>
                  </div>
                </AlertDescription>
              </Alert>
